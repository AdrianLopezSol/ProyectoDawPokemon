...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aH, request.aV, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {T: fragment, W: host, ab: path, ad: port_, ag: protocol, ah: query};
	});
...
var $author$project$Main$initialModel = {x: false, aa: 1, C: _List_Nil, K: '', l: _List_Nil};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$PokemonListReceived = function (a) {
	return {$: 1, a: a};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aw: false, ay: r.ay, aC: r.aC, U: r.U, aH: r.aH, aR: r.aR, aq: r.aq, aV: r.aV}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{ay: $elm$http$Http$emptyBody, aC: r.aC, U: _List_Nil, aH: 'GET', aR: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, aV: r.aV});
};
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$Pokemon = F3(
	function (id, name, types) {
		return {X: id, H: name, aT: types};
	});
...
var $author$project$Main$typeDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$Type,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string));
var $author$project$Main$pokemonDecoder = A4(
	...
	A2(
		...
		'types',
		$elm$json$Json$Decode$list($author$project$Main$typeDecoder)));
var $author$project$Main$pokemonListDecoder = $elm$json$Json$Decode$list($author$project$Main$pokemonDecoder);
var $author$project$Main$fetchPokemonData = $elm$http$Http$get(
	{
		aC: A2($elm$http$Http$expectJson, $author$project$Main$PokemonListReceived, $author$project$Main$pokemonListDecoder),
		aV: 'http://localhost:8080/api/pokemon'
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 3:
				var typeId = msg.a;
				var updatedTypes = A2($elm$core$List$member, typeId, model.l) ? A2(
					$elm$core$List$filter,
					function (t) {
						return !_Utils_eq(t, typeId);
					},
					model.l) : A2($elm$core$List$cons, typeId, model.l);
			...
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{x: true}),
					$author$project$Main$fetchPokemonData);
			case 0:
				var typeId = msg.a;
				var updatedTypes = A2($elm$core$List$member, typeId, model.l) ? A2(
					$elm$core$List$filter,
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{x: true, C: _List_Nil, l: updatedTypes}),
					$elm$core$Platform$Cmd$none);
			case 5:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			default:
				if (!msg.a.$) {
					var pokemonList = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{x: false, C: pokemonList}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Main$TypeButtonClicked = function (a) {
	return {$: 0, a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('type-buttons-container')
					]),
				A2(
					$elm$core$List$map,
					function (typeId) {
						return A2(
							...
							_List_fromArray(
								[
									...
									$author$project$Main$TypeButtonClicked(typeId))
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(
									$elm$core$String$fromInt(typeId))
								]));
					},
					_List_fromArray(
						[1, 2, 3]))),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Main$SearchBarChanged)
							]),
						_List_Nil)
					])),
				A2(
